object frmConsulta_Venda: TfrmConsulta_Venda
  ...
  object pnFrontal: TPanel
    ...
    object pnToolbar: TPanel
      ...
      Color = 2171170
      TabOrder = 2
      object btnEfetuarConsulta: TSpeedButton
        Left = 530
        Top = 6
        Width = 160
        Height = 42
        ...
        Font.Style = [fsBold]
        ParentFont = False
        OnClick = btnEfetuarConsultaClick
      end
    ...
    object GroupBox2: TGroupBox
      ...
      ParentFont = False
      TabOrder = 4
      object gridConsultaItens: TDBGrid
        Left = 2
        Top = 17
        Width = 1085
        Height = 220
  ...
  object dsItensVenda: TDataSource
    DataSet = dmConexoes.qrItensVenda
    Left = 980
    Top = 560
  end
end
