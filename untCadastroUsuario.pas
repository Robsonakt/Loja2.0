 ...
 with dmConexoes do
  begin
     ...
     //         qrUsuario.FieldByName('data').AsDateTime                            := edtDatacri.Date;
              ...
              application.MessageBox('Usuario Cadastrado com Sucesso','Cadastro  ',mb_ok+MB_ICONINFORMATION);
