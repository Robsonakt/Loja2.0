...
begin
    if Key = #13 then DBGridVALORES.SetFocus;
end;
...
begin
  if dmConexoes.qrEstoque.State in [dsEdit, dsInsert] then
    Exit;
...
procedure TfrmCadastroProdutos.PnLocalizaMouseLeave(Sender: TObject);
begin
